...
_folder = "Reconstruction/BD_BB_DwarfHall1/Meshes"
...
# Batch 14: StaticMesh'Suburbs_Floor_Stone_IND_A_Tagged' (11 instances)
...
a = spawn_static_mesh(_mesh_path, _materials, (3145.5142, 4723.368, 847.8854), (-2.135620194662749, 0.15021271157886543, 2.038400217245376), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_A11_499", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (5387.343, 5177.2207, 908.8155), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_A8_155", _folder)
if a: placed += 1
else: skipped += 1
...
# Batch 15: StaticMesh'Suburbs_Floor_Stone_IND_B_Tagged' (23 instances)
_mesh_path = "/Game/Art/Assets/Kits/Architecture/Suburbs/Deco_Tagged/Suburbs_Floor_Stone_IND_B_Tagged"
_materials = ['/Game/Art/Assets/Kits/Architecture/Suburbs/Materials/Suburbs_Floor_Stone_IND/MI_Suburbs_Floor_Stone_IND_MAT_Inst_Dest']
_folder = "Reconstruction/BD_BB_DwarfHall1/Meshes"
a = spawn_static_mesh(_mesh_path, _materials, (1352.3976, 3293.4526, 807.5334), (0.0, -179.9999795094293, 0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_B_334", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (3032.3987, 1450.5383, 859.22473), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0052562), "Suburbs_Floor_Stone_IND_B17", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (3133.8784, 4859.327, 857.908), (0.0, 0.0, 1.497379036287797), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_B18_489", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (1806.0891, 3331.8674, 807.9087), (0.0, -179.9999795094293, 0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_B2_355", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (1321.0446, 1844.4877, 858.1543), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_B3_466", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (5400.0435, 4148.0356, 907.0287), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_B5_647", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (5436.2246, 4972.5796, 907.0287), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_B6", _folder)
if a: placed += 1
else: skipped += 1
...
# Batch 16: StaticMesh'Suburbs_Floor_Stone_IND_C_Tagged' (22 instances)
...
a = spawn_static_mesh(_mesh_path, _materials, (5339.4473, 5015.378, 908.60846), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_C11", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (2248.121, 767.5352, 857.8401), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_C13_183", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (2175.8677, 3223.553, 806.7068), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_C2_315", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (2392.8677, 3223.553, 806.7068), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_C22", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (1199.7266, 1672.0707, 856.96783), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_C5", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (5664.7285, 4075.697, 907.2246), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_C8_630", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (5733.0503, 4167.1387, 908.60846), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_C9_641", _folder)
if a: placed += 1
else: skipped += 1

# Batch 17: StaticMesh'Suburbs_Floor_Stone_IND_D_Tagged' (15 instances)
...
# Batch 18: StaticMesh'Suburbs_Floor_Stone_IND_E_Tagged' (35 instances)
_mesh_path = "/Game/Art/Assets/Kits/Architecture/Suburbs/Deco_Tagged/Suburbs_Floor_Stone_IND_E_Tagged"
_materials = ['/Game/Art/Assets/Kits/Architecture/Suburbs/Materials/Suburbs_Floor_Stone_IND/MI_Suburbs_Floor_Stone_IND_MAT_Inst_Dest']
_folder = "Reconstruction/BD_BB_DwarfHall1/Meshes"
a = spawn_static_mesh(_mesh_path, _materials, (1976.9806, 3241.6826, 809.6329), (0.0, -179.9999590188648, 0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E_303", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (4286.749, 5829.1377, 908.68317), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E11_595", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (5218.8833, 4674.5703, 910.0455), (2.396570052601309, 90.00002533601699, 1.7175865967151994e-06), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E19_59", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (3819.4355, 4664.0425, 910.7515), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E20_195", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (2141.7456, 820.2009, 858.6979), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E22_190", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (3239.2336, 4800.0225, 859.9517), (-1.981292545528637, -89.99993929957522, 1.5123630876092253), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E28", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (3118.2249, 2759.9602, 857.5584), (1.1262572112131126, 0.03639539482730812, -0.4107971156435205), (1.0, 1.0, 0.40624163), "Suburbs_Floor_Stone_IND_E29_511", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (3189.4175, 2865.095, 856.89667), (-0.011383054474502236, -179.61293230968425, 1.6762357251308186), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E30", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (1596.0488, 3242.888, 808.71265), (0.0, -179.9999795094293, 0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E4", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (1293.291, 3168.9724, 808.1543), (0.0, -179.9999795094293, 0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E6_343", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (1086.9004, 1779.2227, 858.7329), (0.0, 89.99998684315639, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E7", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (1943.9095, 2796.8518, 857.96295), (0.0, 0.0, 3.992893025275677), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_E9_484", _folder)
if a: placed += 1
else: skipped += 1

# Batch 19: StaticMesh'Suburbs_Floor_Stone_IND_F_Tagged' (7 instances)
_mesh_path = "/Game/Art/Assets/Kits/Architecture/Suburbs/Deco_Tagged/Suburbs_Floor_Stone_IND_F_Tagged"
_materials = ['/Game/Art/Assets/Kits/Architecture/Suburbs/Materials/Suburbs_Floor_Stone_IND/MI_Suburbs_Floor_Stone_IND_MAT_Inst_Dest']
_folder = "Reconstruction/BD_BB_DwarfHall1/Meshes"
a = spawn_static_mesh(_mesh_path, _materials, (1297.9299, 1956.5693, 860.456), (0.0, 5.7221150373470815, -0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_F_472", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (3188.5747, 1461.5953, 856.87085), (0.0, -177.1873735835285, 0.0), (1.0, 1.0, 1.0), "Suburbs_Floor_Stone_IND_F6_533", _folder)
if a: placed += 1
else: skipped += 1
...
# Batch 20: StaticMesh'Dwarf_Hall_Column_Mural_Large' (8 instances)
...
# Batch 21: StaticMesh'Suburb_Stairs_Trim_3M_B' (82 instances)
...
# Batch 22: StaticMesh'Suburb_Stairs_Trim_Angle_B' (92 instances)
...
# Batch 23: StaticMesh'Suburbs_Column_Large_A_Base' (260 instances)
...
# Batch 24: StaticMesh'Suburbs_Column_Large_A_Capitol' (260 instances)
...
# Batch 25: StaticMesh'Suburbs_Column_Large_A_Shaft' (280 instances)
...
# Batch 26: StaticMesh'Suburbs_Column_Single_Arch_A' (49 instances)
...
# Batch 27: StaticMesh'Suburbs_Column_Single_Capitol_A' (84 instances)
...
# Batch 28: StaticMesh'Suburbs_Column_X_Large_A_ArchL' (76 instances)
...
# Batch 29: StaticMesh'Suburbs_Column_X_Large_A_ArchR' (76 instances)
...
# Batch 30: StaticMesh'Suburbs_Column_X_Large_A_Base_1' (136 instances)
...
# Batch 31: StaticMesh'Suburbs_Column_X_Large_A_Base_1_R' (136 instances)
...
# Batch 32: StaticMesh'Suburbs_Column_X_Large_A_Base_A' (38 instances)
...
# Batch 33: StaticMesh'Suburbs_Column_X_Large_A_Base_B' (4 instances)
...
# Batch 34: StaticMesh'Suburbs_Column_X_Large_A_Base_Corner' (1 instances)
...
# Batch 35: StaticMesh'Suburbs_Column_X_Large_A_CapitalL' (60 instances)
...
# Batch 36: StaticMesh'Suburbs_Column_X_Large_A_CapitalR1' (60 instances)
...
# Batch 37: StaticMesh'Suburbs_Column_X_Large_A_Capitol' (8 instances)
...
# Batch 38: StaticMesh'Suburbs_Column_X_Large_A_Captol_Corner' (4 instances)
...
# Batch 39: StaticMesh'Suburbs_Column_X_Large_A_Lower_Corner' (8 instances)
...
# Batch 40: StaticMesh'Suburbs_Column_X_Large_A_Shaft' (274 instances)
...
# Batch 41: StaticMesh'Suburbs_Column_X_Large_A_Shaft_Corner' (4 instances)
...
# Batch 42: StaticMesh'Suburbs_Floor_1x1m_A' (6 instances)
...
# Batch 43: StaticMesh'Suburbs_Floor_3x3m_A' (1 instances)
...
# Batch 44: StaticMesh'Suburbs_Floor_3x9m_B' (30 instances)
...
# Batch 45: StaticMesh'Suburbs_Floor_Trim_A_2m' (2 instances)
...
# Batch 46: StaticMesh'Suburbs_Stairs_Small_A_NonDest' (6 instances)
...
# Batch 47: StaticMesh'Suburbs_Stairs_Small_B_NonDest' (5 instances)
...
# Batch 49: StaticMesh'Suburbs_Stairs_Small_C_NonDest' (19 instances)
...
# Batch 50: StaticMesh'Suburbs_Stairs_Small_D1' (6 instances)
...
# Batch 51: StaticMesh'Suburbs_Stairs_Small_D2' (1 instances)
...
# Batch 52: StaticMesh'Suburbs_Stairs_Small_D_NonDest' (63 instances)
...
# Batch 53: StaticMesh'Suburbs_Wall_Thick_3x3m_A' (20 instances)
...
# Batch 54: StaticMesh'Suburbs_Wall_Thin_Arch_Half_E_3m' (136 instances)
...
# Batch 55: StaticMesh'Trim_A_2m' (3 instances)
...
# Batch 57: StaticMesh'Dirt_Mound_D' (2 instances)
...
# Batch 58: StaticMesh'Dirt_Mound_E' (1 instances)
...
# Batch 59: StaticMesh'Dirt_Mound_F' (1 instances)
...
# Batch 60: StaticMesh'Dirt_Mound_G' (12 instances)
...
# Batch 61: StaticMesh'Dirt_Mound_H' (8 instances)
...
# Batch 62: StaticMesh'Dirt_Mound_I' (21 instances)
...
# Batch 63: StaticMesh'Dirt_Mound_I' (1 instances)
_mesh_path = "/Game/Art/Assets/Kits/Misc/Dirt_Mounds/Dirt_Mound_I"
_materials = ['/Game/Art/Assets/Kits/Misc/Dirt_Mounds/Materials/Sururbs_Dirt_Fix_Inst']
_folder = "Reconstruction/BD_BB_DwarfHall1/Meshes"
...
# Batch 64: StaticMesh'Mining_Dirt_Mound_A' (5 instances)
...
# Batch 65: StaticMesh'Mining_Dirt_Mound_B' (52 instances)
...
# Batch 66: StaticMesh'Mining_Dirt_Mound_C' (25 instances)
...
# Batch 67: StaticMesh'Orc_Fort_9X9_Mound' (17 instances)
...
# Batch 68: StaticMesh'Orc_Shanty_Tent_Medium_A_Custom_Mound_B' (2 instances)
...
# Batch 69: StaticMesh'Suburbs_Dirt_Mound_A' (49 instances)
...
# Batch 70: StaticMesh'Suburbs_Dirt_Mound_B' (25 instances)
...
# Batch 71: StaticMesh'Suburbs_Dirt_Mound_C' (9 instances)
...
# Batch 72: StaticMesh'Suburbs_Dirt_Mound_Corner_1m' (1 instances)
...
# Batch 73: StaticMesh'Suburbs_Dirt_Mound_Corner_2m' (7 instances)
...
# Batch 74: StaticMesh'Suburbs_Dirt_Mound_D' (27 instances)
...
# Batch 75: StaticMesh'PWM_Quarry_RockDebris_A_Tagged' (20 instances)
...
a = spawn_static_mesh(_mesh_path, _materials, (5438.0034, 4145.2173, 897.45233), (0.0, 135.61149181599203, -0.0), (1.0, 1.0, 1.0), "PWM_Quarry_RockDebris_A12", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (5627.404, 4159.3154, 897.6057), (0.0, -129.09393661392912, 0.0), (1.0, 1.0, 1.0), "PWM_Quarry_RockDebris_A13", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (5637.175, 4235.347, 894.0739), (0.0, -129.09393661392912, 0.0), (1.0, 1.0, 1.0), "PWM_Quarry_RockDebris_A14", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (2128.4136, 646.3265, 844.4451), (0.0, 97.183319704066, -0.0), (1.0, 1.0, 1.0), "PWM_Quarry_RockDebris_A19", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (4384.236, 5829.482, 899.6676), (0.0, -151.60374411085385, 0.0), (1.0, 1.0, 1.0), "PWM_Quarry_RockDebris_A20", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (1245.897, 2084.29, 842.7972), (0.0, -14.125030850703205, 0.0), (1.0, 1.0, 1.0), "PWM_Quarry_RockDebris_A5_460", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (1289.9426, 1910.1788, 842.7972), (0.0, -14.125030850703205, 0.0), (1.0, 1.0, 1.0), "PWM_Quarry_RockDebris_A6_463", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (1060.1542, 2007.25, 842.7972), (0.0, -14.125030850703205, 0.0), (1.0, 1.0, 1.0), "PWM_Quarry_RockDebris_A7", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (2020.2756, 2719.2107, 848.57416), (0.0, -14.125030850703205, 0.0), (1.0, 1.0, 1.0), "PWM_Quarry_RockDebris_A8", _folder)
if a: placed += 1
else: skipped += 1
...
# Batch 76: StaticMesh'PWM_Quarry_Floor_4x4x4_A' (1 instances)
...
_folder = "Reconstruction/BD_BB_DwarfHall1/Construction"
...
_folder = "Reconstruction/BD_BB_DwarfHall1/Breakables"
...
_folder = "Reconstruction/BD_BB_DwarfHall1/DecoVolumes"
