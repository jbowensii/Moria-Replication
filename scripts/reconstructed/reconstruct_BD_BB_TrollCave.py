...
_folder = "Reconstruction/BD_BB_TrollCave/Meshes"
...
a = spawn_static_mesh(_mesh_path, _materials, (3382.2798, 5441.331, 734.9652), (7.2633848413421855, -9.411409216618333, 4.997651409008596), (0.962839, 1.0, 1.0), "PWM_Nordic_8x8x8_A178", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (3675.6582, 5559.901, 836.5255), (1.6017754204265944, -61.72262440576047, -3.8909606894497477), (0.8563048, 0.867481, 0.828117), "PWM_Nordic_8x8x8_A180", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (3668.7793, 5329.467, 554.92914), (0.053145721366973535, -33.942445339818796, 3.333120344089851), (0.8756175, 0.8277332, 0.53578085), "PWM_Nordic_8x8x8_A216", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (2780.8186, 5409.253, 911.02686), (0.26429797021253104, 4.750121501470854, -4.092804076078403), (1.0, 1.0, 1.0), "PWM_Nordic_8x8x8_A31", _folder)
if a: placed += 1
else: skipped += 1
...
# Batch 17: StaticMesh'PWM_Nordic_Blend_B' (44 instances)
...
a = spawn_static_mesh(_mesh_path, _materials, (3871.9858, 5342.5796, 679.6678), (6.091278228160606, 69.1224863702861, 3.062369043441763), (1.0, 1.0, 1.0), "PWM_Nordic_Blend_B5", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (3692.8137, 5518.0093, 1114.392), (3.144625819028424, 33.567726147018206, 174.34323527820447), (1.981949, 1.695827, 2.161899), "PWM_Quarry_2x2x2_A11", _folder)
if a: placed += 1
else: skipped += 1
...
# Batch 19: StaticMesh'PWM_Quarry_4x3x10_A' (95 instances)
...
a = spawn_static_mesh(_mesh_path, _materials, (3469.6428, 5197.9346, 1164.3588), (5.2784181776608134, -175.98295738023722, 3.8530876979834168), (1.0, 1.0, 0.705696), "PWM_Quarry_4x3x10_A596", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (3832.047, 5498.189, 1341.7114), (3.413133914542064, 38.39659880124343, 169.00820514658747), (1.0, 1.0, 0.705696), "PWM_Quarry_4x3x10_A597", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (3691.543, 5427.5537, 1338.7405), (0.7818098546274003, -162.4908801978448, -168.5203426007958), (1.0, 1.0, 0.705696), "PWM_Quarry_4x3x10_A598", _folder)
if a: placed += 1
else: skipped += 1
...
_folder = "Reconstruction/BD_BB_TrollCave/Construction"
...
_folder = "Reconstruction/BD_BB_TrollCave/Breakables"
...
_folder = "Reconstruction/BD_BB_TrollCave/DecoVolumes"
