...
Bubble: BD_BB_GrendelCave_AllInterfaces
...
BUBBLE_NAME = "BD_BB_GrendelCave_AllInterfaces"
placed = 0
skipped = 0
errors = 0
...
_folder = "Reconstruction/BD_BB_GrendelCave_AllInterfaces/Meshes"
...
a = spawn_static_mesh(_mesh_path, _materials, (719.72064, 2237.0112, 1136.5695), (-0.6222839289015706, -21.352204519231528, 10.692307555155507), (0.70271194, 0.8569631, 1.1908153), "PWM_Nordic_8x8x8_A155", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (4698.5425, 839.0332, 1340.621), (3.517054317705281, 53.9142477148426, 0.5178222935081599), (0.9769572, 0.930051, 1.3883166), "PWM_Nordic_8x8x8_A198", _folder)
if a: placed += 1
else: skipped += 1
a = spawn_static_mesh(_mesh_path, _materials, (3213.2434, 707.9248, 1807.0605), (-20.20281853111876, 64.02434964889623, 169.15712212543653), (0.60337394, 1.0955894, 0.75962394), "PWM_Nordic_8x8x8_A199", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (5460.5527, 627.1726, 1163.2286), (-4.368102309012674, 95.05620618533622, 2.6135723375266484), (0.930051, 0.930051, 1.1917176), "PWM_Nordic_8x8x8_A212", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (4053.6199, 1572.8545, 1135.8), (3.1536280490479114, -2.1428835878277868, 6.111023098765406), (1.0, 1.1113013, 0.716295), "PWM_Quarry_4x3x10_A576", _folder)
if a: placed += 1
else: skipped += 1
...
a = spawn_static_mesh(_mesh_path, _materials, (4492.0996, 1396.0527, 1190.176), (-4.126160036474553, 12.570617242413169, 0.64044182454678), (1.1151954, 1.0300118, 0.716295), "PWM_Quarry_4x3x10_A615", _folder)
if a: placed += 1
else: skipped += 1
...
_folder = "Reconstruction/BD_BB_GrendelCave_AllInterfaces/Construction"
...
_folder = "Reconstruction/BD_BB_GrendelCave_AllInterfaces/Breakables"
...
_folder = "Reconstruction/BD_BB_GrendelCave_AllInterfaces/DecoVolumes"
