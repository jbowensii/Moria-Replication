...
#include "ApplyEffectRadiusComponent.generated.h"
...
class MORIA_API UApplyEffectRadiusComponent : public UCapsuleComponent {
    GENERATED_BODY()
public:
protected:
...
public:
    UApplyEffectRadiusComponent(const FObjectInitializer& ObjectInitializer);
